  ...
  <VDialog :model-value="props.isDialogVisible" max-width="600" @update:model-value="dialogVisibleUpdate">
    <VCard class="refer-and-earn-dialog pa-3 pa-sm-11">
      ...
      <VCardText class="pa-5">
        ...
        <VRow>
          <VCol cols="6">
            <VSelect v-model="form.method_payment" :items="method_payments" label="Metodos de pago" item-title="name"
              item-value="id" placeholder="Select Metodo" eager />
          </VCol>
          <VCol cols="6">
            <VTextField label="Monto:" v-model="form.amount" type="number" placeholder="Monto de adelanto" />
          </VCol>
        </VRow>
