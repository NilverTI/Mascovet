        ...
        <VCard title="Roles y Permisos">
            <VCardText class="d-flex flex-wrap gap-4">
                ...
                <div class="d-flex gap-x-4 align-center">
                    <VBtn color="primary" v-if="isPermission('register_rol')" prepend-icon="ri-add-line"
            ...
            <VDataTable :headers="headers" :items="data" :items-per-page="5" class="text-no-wrap">
                ...
                <template #item.action="{ item }">
                    <div class="d-flex gap-1">
                        <IconBtn size="small" v-if="isPermission('edit_rol')" @click="editItem(item)">
                            <VIcon icon="ri-pencil-line" />
                        </IconBtn>
                        <IconBtn size="small" v-if="isPermission('delete_rol')" @click="deleteItem(item)">
            ...
            <DeleteRoleDialog v-if="role_selected_deleted" :rolSelected="role_selected_deleted" @addRole="list()"
