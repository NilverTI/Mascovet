        ...
        <VCard class="refer-and-earn-dialog pa-3 pa-sm-11">
            <VCardText class="pa-5">
                ...
                <VRow>
                    <!-- Nombre / Apellido -->
                    <VCol cols="12" md="6">
                        <VTextField label="Nombre:" v-model="form.name" placeholder="Ejemplo: Rafael" />
                    </VCol>

                    <VCol cols="12" md="6">
                        <VTextField label="Apellido:" v-model="form.surname" placeholder="Ejemplo: Mendoza" />
                    </VCol>
                    ...
                    <VCol cols="12" md="4">
                        <VSelect :items="type_documents" v-model="form.type_document" label="Tipo de documento"
                            placeholder="Seleccionar Item" eager />
                    </VCol>
                    ...
                    <VCol cols="12" md="4">
                        <AppDateTimePicker v-model="form.birthday" label="Cumpleaños" placeholder="Seleccionar Fecha" />
                    </VCol>
                    ...
                    <VCol cols="12" md="4">
                        <VSeleccionar :items="roles" v-model="form.role_id" label="Rol" item-title="name" item-value="id"
                            placeholder="Seleccionar Rol" eager />
                    </VCol>
                    ...
                    <VCol cols="12" md="6" class="d-flex flex-column align-center">
                        <div class="avatar-upload mt-2">
                            ...
                            <!-- Si NO hay imagen, placeholder dentro del cuadro -->
                        ...
                        <tr v-for="item in hour_days" :key="item.hour">
                            ...
                            <td v-for="(day, index) in days" :key="index">
                                <div class="demo-space-x my-2">
                                    ...
                                    <template v-for="(segment_time, index2) in item.segments_time" :key="index2">
...
<style lang="scss">
/* Cuadro de imagen cuadrado, mismo estilo que el de editar */
.avatar-upload {
    position: relative;
    width: 100%;
    max-width: 280px;
