        ...
        <VCard title="Veterinarios">
            <VCardText class="d-flex flex-wrap gap-4">
                ...
                <div class="d-flex gap-x-4 align-center">
                    <VBtn color="primary" prepend-icon="ri-add-line" v-if="isPermission('register_veterinary')"
            ...
            <VDataTable :headers="headers" :items="data" :items-per-page="5" class="text-no-wrap">
                ...
                <template #item.action="{ item }">
                    <div class="d-flex gap-1">
                        <IconBtn size="small" v-if="isPermission('edit_veterinary')" @click="editItem(item)">
                            <VIcon icon="ri-pencil-line" />
                        </IconBtn>
                        <IconBtn size="small" v-if="isPermission('delete_veterinary')" @click="deleteItem(item)">
            ...
            <DeleteVeterinarioDialog v-if="staff_selected_deleted" :userSelected="staff_selected_deleted"
